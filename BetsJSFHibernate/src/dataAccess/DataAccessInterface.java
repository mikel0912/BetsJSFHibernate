...
public interface DataAccessInterface {
	...
	Registered storeRegistered(String username, String password, Integer bankAccount) throws ErabiltzaileaAlreadyExist;
	
	boolean isLogin(String username, String password);
	
	boolean gertaerakSortu(String description,Date eventDate, Sport sport) throws EventFinished;
	
	List<Sport> getSports();
	
	List<Event> getEventsSport(Sport sp);
	
	boolean gertaeraEzabatu(Event ev);
	
	List<Question> getQuestionDate(Date date);
}